            ...
            public void actionPerformed(ActionEvent e) {
                ...
                for (Projeto p : bdProjetos) {
                    if (nome.equals(p.getNome())) {
                        ...
                        ConsultaControler consultControl = new ConsultaControler(ProjetoDAO.getProjetoByNome(nome),semaCons);
        ...
        form.addNewButton.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                if (!form.projectNameTxtField.getText().isEmpty() && dur > 0) {
                    ...
                    p.setNome(form.projectNameTxtField.getText().trim());
                    p.setDuracao(dur);
                    //localProjetos.add(p);
        ...
        form.inserirTarButton.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                if (nome.equals(" ") || nome.isEmpty()){
                    ...
                    TarefaControler tarControler = new TarefaControler(ProjetoDAO.getProjetoByNome(nome));
                    tarControler.start();
